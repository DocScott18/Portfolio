...
def get_config():
    ...
    C.data.reverse_target = True # New Config for Reversed Target (added)
...
class AdditionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        reverse = getattr(self.config, 'reverse_target', True)  # Additional Fallback Argument if Missing (added)
        ...
        if reverse: # Reversal Check to Change Target (added)
            cstr = cstr[::-1] # reverse c to make addition easier
